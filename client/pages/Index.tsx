            ...
            <div className="flex items-center space-x-8">
              <div className="flex-shrink-0">
                <h1 className="text-xl font-bold">
                  Global <span className="text-cyan-400">ADVERTISING</span>{" "}
                  EXCHANGE
                </h1>
              </div>
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between">
            <div className="lg:w-1/2 mb-8 lg:mb-0">
              <h2 className="text-5xl lg:text-6xl font-bold mb-6">
                Global
                <br />
                <span className="text-cyan-400">ADVERTISING</span>
                <br />
                EXCHANGE
              </h2>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between mb-8">
            <h3 className="text-2xl font-bold text-white">
              HOT <span className="text-cyan-400">AUCTIONS</span>
            </h3>
                  ...
                  <div>
                    ...
                    <div className="flex items-center space-x-4 text-sm text-gray-400">
                      <span className="flex items-center">
                        <Eye className="h-4 w-4 mr-1" /> 1,247 views
                      </span>
                      <span className="flex items-center">
                        <Users className="h-4 w-4 mr-1" /> 89 bidders
                      </span>
                    </div>
                  </div>
                  <img
      ...
      <section className="py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              {
                title: "NY Times Square",
                price: "$2,450",
                location: "New York, USA",
                image:
                  "https://images.unsplash.com/photo-1564424188345-e14ca3e4b8b3?w=300&h=200&fit=crop",
              },
              {
                title: "Tokyo Digital",
                price: "$1,890",
              ...
              },
              {
                ...
                image:
                  "https://images.unsplash.com/photo-1546726747-421c6d69c929?w=300&h=200&fit=crop",
              },
            ].map((item, index) => (
              <Card
                key={index}
                className="bg-navy-800 border-navy-700 overflow-hidden"
              >
                <img
                  src={item.image}
                  alt={item.title}
            ...
            {[
              {
                ...
                description:
                  "Create a profile on our advertising marketplace. List your advertising space inventory for global brands.",
              },
              {
                icon: <Eye className="h-12 w-12 text-cyan-400" />,
                title: "Fill out ads, receive spot biding",
                description:
                  "Set your pricing and requirements. Receive real-time bids from advertisers worldwide for your available spots.",
              },
              {
                icon: <DollarSign className="h-12 w-12 text-cyan-400" />,
                title: "Auctions and forward pricing",
                description:
                  "Participate in live auctions or set forward pricing for future campaigns. Maximize your revenue potential.",
              },
            ].map((step, index) => (
              <Card
                key={index}
                className="bg-navy-800 border-navy-700 text-center"
              >
      ...
      <section className="py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              {
                title: "Tesla Roadster auction nets $94M",
                time: "2 hours ago",
                category: "Auctions",
              },
              {
                title: "NY Times Square reaches 2.4M monthly views",
                time: "4 hours ago",
                category: "Analytics",
              },
              {
                title: "The truth about display advertising ROI",
                time: "6 hours ago",
                category: "Insights",
              },
              {
                title: "Blockchain pricing updates in real-time",
                time: "8 hours ago",
                category: "Technology",
              },
            ].map((news, index) => (
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400 text-sm">
                Empowering advertisers and space owners with transparent,
                efficient marketplace solutions.
              </p>
            </div>
            <div>
